-- migration:owner_truth_interview_session_end
--
-- Add the value-free, owner-scoped end-of-session receipt shape. The command
-- only closes a private conversation thread/session pair; it does not carry a
-- transcript, Candidate, DecisionReceipt, MemoryVersion or provider result.

...
echo "== Owner Truth Thread-summary projection gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-owner-truth-thread-summary-projection-gate.sh
...
echo "== Owner Truth media Provider readiness matrix gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-owner-truth-media-provider-matrix-gate.sh
...
echo "== Owner Truth closed-pilot text capture gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-owner-truth-text-capture-gate.sh
...
echo "== Owner Truth migration C07 cutover admission gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-owner-truth-cutover-admission-shadow-gate.sh

echo "== Owner Truth migration C08 lane activation gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-owner-truth-migration-lane-activation-g0-gate.sh

echo "== Owner Truth migration C09 rights/restore/replay gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-owner-truth-migration-rights-restore-replay-g0-gate.sh
...
echo "== Publication public projector G0 contract gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-publication-public-projector-g0-gate.sh
...
echo "== Publication Visitor access default-off gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-publication-visitor-access-gate.sh
...
echo "== Publication canary/exit-readiness G0 contract gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-publication-canary-exit-readiness-g0-gate.sh
...
echo "== Voice/Digital Human lane-readiness G0 gate =="
PYTHON_BIN="$PYTHON_BIN" scripts/run-backend-voice-dh-lane-readiness-g0-gate.sh
...
test -f scripts/purge_expired_account_deletions.py
test -f scripts/run-purge-expired-account-deletions.sh
...
test -f db/migrations/0047_owner_truth_legacy_backfill_admission_plan.sql
test -f db/migrations/0047_owner_truth_legacy_backfill_admission_plan.json
test -f app/domain/owner_truth/legacy_backfill.py
test -f app/services/owner_truth_legacy_backfill.py
test -f tests/test_owner_truth_legacy_backfill_plan.py
test -f tests/test_owner_truth_legacy_backfill_service.py
...
test -f app/services/owner_truth_legacy_tail_shadow.py
...
test -f app/services/owner_truth_cutover_admission_shadow.py
test -f tests/test_owner_truth_cutover_admission_shadow.py
test -f scripts/run-backend-owner-truth-cutover-admission-shadow-gate.sh
test -f docs/backend/2026-07-29-owner-truth-c07-cutover-admission-g0.md
test -f app/domain/owner_truth/migration_lane_activation_shadow.py
test -f tests/test_owner_truth_migration_lane_activation_shadow.py
test -f scripts/run-backend-owner-truth-migration-lane-activation-g0-gate.sh
test -f docs/backend/2026-07-29-owner-truth-c08-lane-activation-g0.md
test -f tests/test_owner_truth_migration_rights_restore_replay_g0.py
test -f scripts/run-backend-owner-truth-migration-rights-restore-replay-g0-gate.sh
test -f docs/backend/2026-07-29-owner-truth-c09-rights-restore-replay-g0.md
test -f app/domain/owner_truth/migration_retirement_candidate_shadow.py
...
test -f scripts/backend-owner-truth-interview-natural-input-deployed-smoke.py
test -f scripts/run-backend-owner-truth-interview-natural-input-deployed-smoke.sh
...
test -f app/services/digital_human_session_lifecycle_shadow.py
test -f tests/test_digital_human_session_lifecycle_shadow.py
test -f scripts/run-backend-digital-human-session-lifecycle-g0-gate.sh

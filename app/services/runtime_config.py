    ...
    def public_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "archive": {
                ...
                "uploadURLScheme": "none",
                "realProviderReady": False,
                "providerSwitchContractVersion": 1,
                "clientUploadAction": "disabled",
                "supportedMediaKinds": [],
            ...
            "ownerTruthMedia": {
                ...
                "supportedMediaKinds": ["document", "image"],
                "contractVersion": 1,
            },
    ...
    def _capability_snapshots(
        ...
        *,
        ...
        inputs = (
            ...
            RuntimeCapabilityInput(
                capability="kbliteUserSurface",
                implemented=True,
                enabled=False,
                provider_ready=False,
                release_visible=release_decisions["kbliteUserSurface"].releaseVisible,
                external_verified=False,
                provider="internalKnowledgeStore",
                fallback_mode="disabled",
                reason="productClosed",
                provider_kind="internalUserInterface",
                operation="presentKnowledgeBase",
                data_class="ownerPrivateKnowledge",
                region="serviceManaged",
                retention_policy_version="kblite-v1",
                configuration_status="productClosed",
                evidence_status="notRequested",
            ),
            RuntimeCapabilityInput(
                capability="accountDataExport",
                implemented=True,
                enabled=False,
                provider_ready=False,
                release_visible=release_decisions["accountDataExport"].releaseVisible,
                external_verified=False,
                provider="internalExportService",
                fallback_mode="disabled",
                reason="productClosed",
                provider_kind="accountExport",
                operation="exportFullAccountData",
                data_class="ownerAccountData",
                region="serviceManaged",
                retention_policy_version="accountExport-v1",
                configuration_status="productClosed",
                evidence_status="notRequested",
            ),
            RuntimeCapabilityInput(

...
class RouteOwnershipRegistry:
    ...
    def __init__(self) -> None:
        ...
        self.rules = (
            ...
            _rule("GET", "/v2/vaults/{vault_id}/narrative-projects", session, "narrativeProjectList"),
            _rule("POST", "/v2/vaults/{vault_id}/narrative-projects", session, "narrativeProjectCreate"),
            _rule("GET", "/v2/vaults/{vault_id}/narrative-projects/{project_id}", session, "narrativeProjectRead"),
            _rule("DELETE", "/v2/vaults/{vault_id}/narrative-projects/{project_id}", session, "narrativeProjectDelete"),
            _rule("GET", "/v2/vaults/{vault_id}/narrative-projects/{project_id}/readiness", session, "narrativeReadiness"),
            _rule("POST", "/v2/vaults/{vault_id}/narrative-projects/{project_id}/commands", session, "narrativeCommand"),
            _rule("GET", "/v2/vaults/{vault_id}/narrative-projects/{project_id}/jobs/{job_id}", session, "narrativeJobRead"),
            _rule("POST", "/v2/vaults/{vault_id}/narrative-projects/{project_id}/jobs/{job_id}/cancel", session, "narrativeJobCancel"),
            _rule("GET", "/v2/vaults/{vault_id}/narrative-projects/{project_id}/artifacts", session, "narrativeArtifactList"),
            _rule("GET", "/v2/vaults/{vault_id}/narrative-projects/{project_id}/artifacts/{artifact_version_id}", session, "narrativeArtifactRead"),
            _rule("GET", "/v2/vaults/{vault_id}/narrative-projects/{project_id}/reader/manifest", session, "narrativeReaderManifest"),
            _rule("GET", "/v2/vaults/{vault_id}/narrative-projects/{project_id}/reader/chapters/{chapter_key}", session, "narrativeReaderChapter"),
            _rule("GET", "/v2/vaults/{vault_id}/narrative-projects/{project_id}/export", session, "narrativeExport"),
            _rule(
                "POST",
            ...
            _rule(
                ...
                session,
                "ownerTruthMediaSourceObjectDelete",
                resource_type="mediaSourceObject",
                resource_id_path_parameter="source_object_id",
            ...
            _rule(
                ...
                session,
                "ownerTruthMediaSourceObjectDeletionRetry",
                resource_type="mediaSourceObject",
                resource_id_path_parameter="source_object_id",
                resource_operation="delete",
                requires_existing_resource=True,
            ...
            _rule(
                ...
                session,
                "publicationClosedBetaConfirm",
            ),
            _rule(
                "POST",
                "/v2/vaults/{vault_id}/publications/{publication_id}/withdraw",
                session,
                "publicationClosedBetaWithdraw",
            ),
            _rule(
                "POST",
                "/v2/vaults/{vault_id}/publications/{publication_id}/suspend",
                session,
                "publicationClosedBetaSuspend",
            ),
            _rule(
                "GET",
                "/v2/vaults/{vault_id}/publication-grants",
                session,
                "publicationClosedBetaShareGrantList",
            ),
            _rule(
                "POST",
                "/v2/vaults/{vault_id}/publication-grants",
                session,
                "publicationClosedBetaShareGrantIssue",
            ),
            _rule(
                "POST",
            ...
            _rule(
                ...
                session,
                "publicationClosedBetaVisitorSessionAdmission",
            ),
            _rule(
                "POST",
                "/v2/publication-sessions/{session_id}/projection",
                session,
                "publicationClosedBetaVisitorProjectionRead",
            ),
            _rule(
                "POST",
                "/v2/publication-sessions/{session_id}/answers",
                session,
                "publicationClosedBetaVisitorDeterministicAnswer",
            ),
            _rule(
                "POST",
            ...
            _rule(
                ...
                session,
                "ownerTruthFamilyContributionRevoke",
            ),
            _rule(
                "POST",
                "/v2/vaults/{vault_id}/family-contribution-grants/{grant_id}/sources",
                session,
                "ownerTruthFamilyContributionSource",
            ),
            _rule(
                "POST",
                "/v2/vaults/{vault_id}/family-contribution/grants",
            ...
            _rule(
                ...
                session,
                "ownerTruthGuidedRecommendationActivationPresentation",
            ),
            _rule(
                "POST",
            ...
            _rule(
                ...
                session,
                "ownerTruthKnowledgeRecommendationFeedback",
            ),
            _rule(
                "POST",
            ...
            _rule(
                ...
                session,
                "ownerTruthInterviewSessionOrchestrationRead",
            ),
            _rule(
                "GET",
            ...
            _rule(
                "POST",
                "/v2/vaults/{vault_id}/interview-review-batches/{review_batch_id}/confirmation/candidates/{candidate_id}/decision",
                session,
                "ownerTruthInterviewCandidateConfirmationSingleDecision",
            ),
            _rule(
                "POST",
            ...
            _rule(
                "POST",
                "/ops/test-accounts/{account_id}/disable",
                system,
                "systemTestAccountManage",
                required_scopes=("testAccount:manage",),
            ),
            _rule(
                "POST",
                "/ops/test-accounts/{account_id}/enable",
                system,
                "systemTestAccountManage",
                required_scopes=("testAccount:manage",),
            ),
            _rule(
                "POST",
                "/ops/test-accounts/{account_id}/renew",
                system,
                "systemTestAccountManage",
                required_scopes=("testAccount:manage",),
            ),

...
_SENSITIVE_KEY_MARKERS = (
    ...
    "signature",
    "token",
    # Provider/object routing identifiers are not part of a personal data
    # export.  They can grant temporary media access or expose vendor-side
    # correlations, so external-boundary status is exported instead.
    "object_key",
    "objectkey",
    "storage_key",
    "storagekey",
    ...
    external_boundaries = [
        {
            ...
            "status": "unsupported",
            "retentionState": "providerControlled",
            "uncompleted": True,
        ...
        },
        {
            ...
            "status": "pending",
            "retentionState": "operatorRetentionWindow",
            "uncompleted": True,
...
def _owner_truth_module_records(store: Any, subject_id: str) -> List[Dict[str, Any]]:
    ...
    Canonical Source/Candidate/MemoryVersion/Citation/Feedback/Correction values
    and the owner's minimized family-contribution authorization records are

...
class OwnerTruthInterviewInputAPITests(unittest.TestCase):
    ...
    def test_formal_topic_switch_creates_hidden_session_exit_batch(self) -> None:
        owner_id, headers, auth_session_id = self._login("13800139624", qa=False)
        headers.update(
            {
                "X-DreamJourney-Feature": "echoTextInput",

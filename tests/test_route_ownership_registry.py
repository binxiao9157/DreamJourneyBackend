...
class RouteOwnershipRegistryTests(unittest.TestCase):
    ...
    def test_high_risk_routes_have_non_service_classification(self):
        expected = {
            ...
            ("POST", "/family/relationships/{relationship_id}/terminate"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/family/relationships"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/v2/vaults/{vault_id}/candidates"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/v2/vaults/{vault_id}/candidate-review-history"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/v2/vaults/{vault_id}/source-records"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/v2/vaults/{vault_id}/source-records/{source_id}"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/v2/vaults/{vault_id}/memories/{memory_id}/versions"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/v2/vaults/{vault_id}/memories"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/v2/vaults/{vault_id}/memories/{memory_id}"): RouteOwnershipCategory.USER_SESSION,
            ...
            ("GET", "/v2/vaults/{vault_id}/candidates/{candidate_id}/decision-result"): RouteOwnershipCategory.USER_SESSION,
            ...
            ("GET", "/v2/vaults/{vault_id}/memory-changeset-groups/decision-result"): RouteOwnershipCategory.USER_SESSION,
            ...
            ("GET", "/v2/vaults/{vault_id}/interview-review-batches/pending"): RouteOwnershipCategory.USER_SESSION,
            ...
            ("GET", "/v2/vaults/{vault_id}/interview-memory-projection-recovery-inbox"): RouteOwnershipCategory.USER_SESSION,
            ...
            ("POST", "/v2/vaults/{vault_id}/interview-review-batches/{review_batch_id}/confirmation/candidates/{candidate_id}/memory-activation"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/interview-review-batches/{review_batch_id}/candidate-proposal/admit"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/v2/vaults/{vault_id}/interview-review-batches/{review_batch_id}/candidate-proposal/status"): RouteOwnershipCategory.USER_SESSION,
            ...
            ("POST", "/v2/vaults/{vault_id}/interview-sessions/{session_id}/end"): RouteOwnershipCategory.USER_SESSION,
            ("GET", "/v2/vaults/{vault_id}/interview-sessions/{session_id}/outcome"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/interview-sessions/{session_id}/pause-for-topic-switch"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/interview-sessions/{session_id}/pacing"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/interview-sessions/{session_id}/defer-with-continuation"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/interview-sessions/{session_id}/restore-do-not-ask"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/interview-sessions/{session_id}/restore-cooldown"): RouteOwnershipCategory.USER_SESSION,
            ...
            ("POST", "/v2/vaults/{vault_id}/context-shadow/compare"): RouteOwnershipCategory.USER_SESSION,
            ...
            ("GET", "/v2/vaults/{vault_id}/guided-recommendations"): RouteOwnershipCategory.USER_SESSION,
            ...
            ("POST", "/v2/vaults/{vault_id}/memory-search"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/memory-search/read"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/memory-search/projection/rebuild"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/knowledge-recommendations/activate"): RouteOwnershipCategory.USER_SESSION,
            ("POST", "/v2/vaults/{vault_id}/knowledge-recommendations/feedback"): RouteOwnershipCategory.USER_SESSION,
